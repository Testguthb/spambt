...
# Скрипт для управління п'ятнадцятьма екземплярами Telegram бота
...
case "$1" in
    ...
    stop)
        ...
        pm2 stop bot1 bot2 bot3 bot4 bot5 bot6 bot7 bot8 bot9 bot10 bot11 bot12 bot13 bot14 bot15
        echo "✅ Боти зупинені!"
        ;;
    restart)
        echo "🔄 Перезапускаю всі боти..."
        pm2 restart bot1 bot2 bot3 bot4 bot5 bot6 bot7 bot8 bot9 bot10 bot11 bot12 bot13 bot14 bot15
...
EOF
        ...
        echo ""
        echo "📋 Не забудьте відредагувати файли .env.bot1 - .env.bot15 з вашими даними:"
    ...
    start-bot)
        if [ -z "$2" ]; then
            echo "❌ Потрібно вказати номер бота (1-15)"
    ...
    restart-bot)
        ...
        ;;
    *)
        echo "🤖 Управління п'ятнадцятьма екземплярами Telegram бота"
        echo ""
        ...
        echo "  logs [bot]   - Показати логи (bot1-bot15 або всі)"
        ...
        echo "  start-bot N  - Запустити бота N (1-15)"
        echo "  stop-bot N   - Зупинити бота N (1-15)"
        echo "  restart-bot N - Перезапустити бота N (1-15)"
        echo ""
        echo "Приклади:"
        ...
        echo "  $0 start-bot 10         # Запустити тільки десятий бот"
